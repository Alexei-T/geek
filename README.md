...
1. [Задание №1 - Отладка на разных этапах загрузки системы и сервисов](https://github.com/Alexei-T/geek/tree/main/Основные%20сервисы%20на%20Linux%20для%20предприятия/1)
<details><summary>Описание задания №1</summary>
